...
import 'package:schools_management/provider/alumno.dart';
import 'package:schools_management/provider/docente.dart';
import 'package:schools_management/screens/parent/main_alumno_page.dart';
import 'package:schools_management/screens/teacher/main_docente_page.dart';
      ...
      if (selectedRadio == 1) {
        ...
        Provider.of<Parent>(context)
          ...
          if (state) {
            ...
            showAlert('Error',
                'Nombre de usuario o password incorrecto'); // otherwise show an Alert
          }
        });
